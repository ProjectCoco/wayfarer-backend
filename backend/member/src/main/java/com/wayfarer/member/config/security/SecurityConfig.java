...
import com.wayfarer.member.config.properties.AppProperties;
import com.wayfarer.member.config.properties.CorsProperties;
import com.wayfarer.member.oauth.exception.RestAuthenticationEntryPoint;
import com.wayfarer.member.oauth.filter.TokenAuthenticationFilter;
import com.wayfarer.member.oauth.handler.OAuth2AuthenticationFailureHandler;
import com.wayfarer.member.oauth.handler.OAuth2AuthenticationSuccessHandler;
import com.wayfarer.member.oauth.handler.TokenAccessDeniedHandler;
import com.wayfarer.member.oauth.repository.HttpCookieOAuth2AuthorizationRequestRepository;
import com.wayfarer.member.oauth.service.PrincipalOAuth2UserService;
